 ...
 */
     var a = this || self;
     var b = ["google", "payments", "api", "EnableChromeOriginTrialForPaymentHandlerMinimalHeader"]
       , c = window || a;
     b[0]in c || "undefined" == typeof c.execScript || c.execScript("var " + b[0]);
     for (var d; b.length && (d = b.shift()); )
         b.length ? c = c[d] && c[d] !== Object.prototype[d] ? c[d] : c[d] = {} : c[d] = !0;
 ...
 */
     ...
     }, p = ca(this), da = "function" === typeof Symbol && "symbol" === typeof Symbol("x"), r = {}, ea = {}, t = function(a, b, c) {
         if (!c || null != a) {
             c = ea[b];
             if (null == c)
                 return a[b];
     ...
     u("Promise", function(a) {
         ...
         ;
         e.prototype.Cc = function(f) {
             if (f === this)
                 this.rb(new TypeError("A Promise cannot resolve to itself"));
         ...
         e.prototype.Bc = function(f) {
             ...
             "function" == typeof h ? this.Gc(h, f) : this.Kb(f)
         }
         ;
         ...
         e.prototype.Dc = function() {
             ...
             d(function() {
                 if (f.uc()) {
                     var h = p.console;
                     "undefined" !== typeof h && h.error(f.W)
                 }
             }, 1)
         }
         ;
         ...
         ;
         var g = new b;
         e.prototype.Fc = function(f) {
             var h = this.eb();
             f.Ma(h.resolve, h.reject)
         }
         ;
         e.prototype.Gc = function(f, h) {
             var l = this.eb();
             try {
         ...
         e.prototype.then = function(f, h) {
             function l(E, G) {
                 return "function" == typeof E ? function(na) {
                     try {
                         k(E(na))
                     } catch (U) {
                         q(U)
         ...
         e.prototype.Ma = function(f, h) {
             function l() {
                 ...
                 case 2:
                     ...
                     break;
                 default:
                     throw Error("Unexpected state: " + k.qa);
                 }
             }
             var k = this;
             null == this.pa ? g.Bb(l) : this.pa.push(l);
             this.Nb = !0
         }
         ;
         e.resolve = c;
         ...
         e.race = function(f) {
             return new e(function(h, l) {
                 for (var k = ha(f), q = k.next(); !q.done; q = k.next())
                     c(q.value).Ma(h, l)
             }
             )
         }
         ...
         e.all = function(f) {
             var h = ha(f)
               , l = h.next();
             return l.done ? c([]) : new e(function(k, q) {
                 function z(na) {
                     return function(U) {
                         E[na] = U;
                         G--;
     ...
     u("WeakMap", function(a) {
         ...
         if (function() {
             ...
             try {
                 var f = Object.seal({})
                   , h = Object.seal({})
                   , l = new a([[f, 2], [h, 3]]);
                 if (2 != l.get(f) || 3 != l.get(h))
                     return !1;
                 l.delete(f);
                 l.set(h, 4);
                 return !l.has(f) && 4 == l.get(h)
             } catch (k) {
                 return !1
             }
         }())
         ...
         var d = "$jscomp_hidden_" + Math.random()
           , e = 0
           , g = function(f) {
             this.wa = (e += Math.random() + 1).toString();
             if (f) {
                 f = ha(f);
         ...
         g.prototype.get = function(f) {
             return c(f) && v(f, d) ? f[d][this.wa] : void 0
         }
         ;
         g.prototype.has = function(f) {
             return c(f) && v(f, d) && v(f[d], this.wa)
         }
         ;
         g.prototype.delete = function(f) {
             return c(f) && v(f, d) && v(f[d], this.wa) ? delete f[d][this.wa] : !1
         }
         ;
         return g
     }, "es6");
     u("Map", function(a) {
         ...
         c.prototype.forEach = function(h, l) {
             for (var k = t(this, "entries").call(this), q; !(q = k.next()).done; )
                 q = q.value,
         ...
         var d = function(h, l) {
             var k = l && typeof l;
             "object" == k || "function" == k ? b.has(l) ? k = b.get(l) : (k = "" + ++f,
             b.set(l, k)) : k = "p_" + l;
             var q = h[0][k];
             if (q && v(h[0], k))
                 for (h = 0; h < q.length; h++) {
                     var z = q[h];
                     if (l !== l && z.key !== z.key || l === z.key)
                         return {
                             id: k,
                             list: q,
                             index: h,
     ...
     var A = function(a, b, c) {
       ...
       , xa = function(a, b, c) {
         "number" !== typeof a && va("Expected number but got %s: %s.", [x(a), a], b, Array.prototype.slice.call(arguments, 2));
         return a
     }
       , ya = function(a, b, c) {
         "string" !== typeof a && va("Expected string but got %s: %s.", [x(a), a], b, Array.prototype.slice.call(arguments, 2))
     }
       , za = function(a, b, c) {
         y(a) || va("Expected object but got %s: %s.", [x(a), a], b, Array.prototype.slice.call(arguments, 2))
     };
     var B = function(a, b) {
         this.wb = a === Aa && b || "";
         this.fc = Ba
     ...
     ;
     var C = function(a) {
         if (a instanceof B && a.constructor === B && a.fc === Ba)
             return a.wb;
     ...
     var Ca = {
       ...
       , Ra = {}
       , Sa = (Ra.PRODUCTION = "AyGMxNwGcOhbvxIgUXurNsB5dO3/gqfsYEEZLDQj7AQxxHR3WhYYv9SikD8bp6nowqK7L1UIEZfYU4veJLbSKQEAAAB5eyJvcmlnaW4iOiJodHRwczovL3BheS5nb29nbGUuY29tOjQ0MyIsImZlYXR1cmUiOiJQYXltZW50SGFuZGxlck1pbmltYWxIZWFkZXJVWCIsImV4cGlyeSI6MTcwMTk5MzU5OSwiaXNUaGlyZFBhcnR5Ijp0cnVlfQ==",
     Ra.SANDBOX = "",
     Ra.TEST = "AyGMxNwGcOhbvxIgUXurNsB5dO3/gqfsYEEZLDQj7AQxxHR3WhYYv9SikD8bp6nowqK7L1UIEZfYU4veJLbSKQEAAAB5eyJvcmlnaW4iOiJodHRwczovL3BheS5nb29nbGUuY29tOjQ0MyIsImZlYXR1cmUiOiJQYXltZW50SGFuZGxlck1pbmltYWxIZWFkZXJVWCIsImV4cGlyeSI6MTcwMTk5MzU5OSwiaXNUaGlyZFBhcnR5Ijp0cnVlfQ==",
     Ra);
     function H(a, b) {
     ...
     ;var Ta = function() {
         this.Jc = I.contentWindow
     };
     Ta.prototype.postMessage = function(a, b) {
         this.Jc.postMessage(a, b)
     }
     ;
     var Ua, Va = function() {
         if (void 0 === Ua) {
     ...
     ;
     var Ya = function(a) {
         if (a instanceof Xa && a.constructor === Xa)
             return a.pb;
         wa("expected object of type TrustedResourceUrl, got '" + a + "' of type " + x(a));
       ...
       , bb = function(a, b) {
         ...
         a = c.replace($a, function(d, e) {
             if (!Object.prototype.hasOwnProperty.call(b, e))
                 throw Error('Found marker, "' + e + '", in format string, "' + c + '", but no valid label mapping found in args: ' + JSON.stringify(b));
             d = b[e];
             return d instanceof B ? C(d) : encodeURIComponent(String(d))
         });
         return ab(a)
     }
       , $a = /%{(\w+)}/g
       , Za = RegExp("^((https:)?//[0-9a-z.:[\\]-]+/|/[^/\\\\]|[^:/\\\\%]+/|[^:/\\\\%]*[?#]|about:blank#)", "i")
       , cb = /^([^?#]*)(\?[^#]*)?(#[\s\S]*)?/
       , Wa = {}
       , ab = function(a) {
         var b = Va();
     ...
     ;
     var hb = new gb("OFF",Infinity), ib = new gb("WARNING",900), jb = new gb("CONFIG",700), kb = function() {
         this.Na = 0;
         this.clear()
     }, lb;
     kb.prototype.clear = function() {
         this.Fb = Array(this.Na);
         this.Gb = -1;
         this.Mb = !1
     }
     ;
     ...
     var nb = function(a, b) {
         ...
         if (c)
             return c;
         c = sb(a, b.slice(0, Math.max(b.lastIndexOf("."), 0)));
         var d = new nb(b,c);
         t(a, "entries")[b] = d;
         c.children.push(d);
         return d
     ...
     var Fb = function(a) {
         if (a instanceof J && a.constructor === J)
             return a.ob;
         wa("expected object of type SafeUrl, got '" + a + "' of type " + x(a));
     ...
     var Hb = Gb
       , Eb = {};
     new J("about:invalid#zClosurez",Eb);
     new J("about:blank",Eb);
     var Ib = {}
       , Jb = function() {
         if (Ib !== Ib)
     ...
     var Mb, Nb;
     a: {
         for (var Ob = ["CLOSURE_FLAGS"], Pb = w, Qb = 0; Qb < Ob.length; Qb++)
             if (Pb = Pb[Ob[Qb]],
             null == Pb) {
                 Nb = null;
                 break a
     ...
     ;
     var Wb = function(a) {
         if (a instanceof L && a.constructor === L)
             return a.nb;
         wa("expected object of type SafeHtml, got '" + a + "' of type " + x(a));
         return "type_error:SafeHtml"
     }
       , Yb = function(a) {
         a instanceof L || (a = "object" == typeof a && a.ga ? a.ea() : String(a),
         Db.test(a) && (-1 != a.indexOf("&") && (a = a.replace(xb, "&amp;")),
       ...
       , $b = function(a) {
         var b = Yb(Zb)
           , c = []
           , d = function(e) {
             Array.isArray(e) ? e.forEach(d) : (e = Yb(e),
             c.push(Wb(e).toString()))
         };
         a.forEach(d);
         return Xb(c.join(Wb(b).toString()))
     }
       , ac = function(a) {
       ...
       , Zb = new L(w.trustedTypes && w.trustedTypes.emptyHTML || "",Vb)
       , bc = Xb("<br>");
     /*
 ...
 */
     var cc = []
       , dc = function(a) {
         var b;
         if (b = sb(tb(), "safevalues").sc) {
             var c = "A URL with content '" + a + "' was sanitized away."
               , d = ib;
             if (a = b)
                 if (a = b && d) {
                     a = d.value;
                     var e = b ? ob(sb(tb(), b.getName())) : hb;
                     a = a >= e.value
                 }
             if (a) {
                 d = d || hb;
     ...
     ;var fc = {
       ...
       , lc = []
       , nc = function() {
         mc({}, 11, ["canMakePaymentForPaymentHandlerResponse"], function() {})
     }
       , mc = function(a, b, c, d) {
         function e(g) {
             var f;
       ...
       , N = function(a) {
         if (kc && gc) {
             a = t(Object, "assign").call(Object, {
                 buyFlowActivityMode: jc,
                 googleTransactionId: hc,
                 originTimeMs: ic
             }, a);
             if ("CANARY" == M)
                 ...
                 b = "https://pay",
                 "SANDBOX" == M ? b += ".sandbox" : "PREPROD" == M && (b += "-preprod.sandbox"),
                 b += ".google.com";
             gc.postMessage(a, b)
         } else
             lc.push(a)
     ...
     (function() {
         if (!I) {
             ...
             M = a.environment || "PRODUCTION";
             I = document.createElement("iframe");
             ec(I, bb(D(("CANARY" == M ? "https://ibfe-canary.corp" : "https://pay") + ("PREPROD" == M ? "-preprod.sandbox" : "SANDBOX" == M ? ".sandbox" : "") + ".google.com/gp/p/ui/payframe?origin=%{windowOrigin}&mid=%{merchantId}"), {
             ...
             I.setAttribute("allowpaymentrequest", !0);
             I.onload = function() {
                 gc = new Ta;
                 N({
                     eventType: 17,
             ...
             ;
             document.body ? document.body.appendChild(I) : document.addEventListener("DOMContentLoaded", function() {
 ...
 */
     var qc = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");
     function rc(a) {
     ...
     function tc(a, b) {
         if ("object" !== typeof b || null === b)
             return a;
         for (var c in b)
             b.hasOwnProperty(c) && void 0 !== b[c] && (null == b[c] ? a[c] = null : null == a[c] || "object" !== typeof a[c] || "object" !== typeof b[c] || Array.isArray(b[c]) || Array.isArray(a[c]) ? a[c] = b[c] : tc(a[c], b[c]));
         return a
     }
     function uc(a) {
         var b = 0, c;
     ...
     function vc(a) {
         console.error("DEVELOPER_ERROR in " + a.aa + ": " + a.errorMessage)
     }
     ;var wc = function(a) {
         wc[" "](a);
         return a
     ...
     wc[" "] = function() {}
     ;
     var xc = Mb && Tb && 0 < Tb.brands.length ? !1 : K("Trident") || K("MSIE")
       , yc = K("Gecko") && !(-1 != Sb().toLowerCase().indexOf("webkit") && !K("Edge")) && !(K("Trident") || K("MSIE")) && !K("Edge")
       , zc = -1 != Sb().toLowerCase().indexOf("webkit") && !K("Edge");
     var Ac = {
         MATH: !0,
         SCRIPT: !0,
         STYLE: !0,
       ...
       , Cc = function(a, b) {
         if (a.tagName && Ac[a.tagName.toUpperCase()])
       ...
       , Dc = function(a, b, c, d) {
         if (!(a instanceof J || a instanceof J)) {
             a = "object" == typeof a && a.ga ? a.ea() : String(a);
             b: {
                 var e = a;
                 if (Hb) {
                     try {
             ...
             A("javascript:" !== e, "%s is a javascript: URL", a) || (a = "about:invalid#zClosurez");
             a = new J(a,Eb)
         }
         b = b || w;
         c = c instanceof B ? C(c) : c || "";
         return void 0 !== d ? b.open(Fb(a), c, d) : b.open(Fb(a), c)
     };
     var Ec = function() {
     ...
     var Gc = function(a) {
         ...
         ya(C(c), "must provide justification");
         ...
         d = c.createElement(d);
         xc ? (Cc(d, ac(bc, b)),
         d.removeChild(A(d.firstChild))) : Cc(d, b);
         if (1 == d.childNodes.length)
             b = d.removeChild(A(d.firstChild));
         else
     ...
     var Hc = function(a) {
       ...
       , Jc = function(a, b, c) {
         if (a.forEach && "function" == typeof a.forEach)
             ...
             for (var d = Ic(a), e = Hc(a), g = e.length, f = 0; f < g; f++)
     ...
     var O = function(a) {
         ...
         if (a instanceof O) {
             ...
             a && (b = String(a).match(Kc)) ? (this.F = !1,
             Nc(this, b[1] || "", !0),
             a = b[2] || "",
             P(this),
             this.ka = Qc(a),
             ...
             a = b[7] || "",
             P(this),
             this.L = Qc(a)) : (this.F = !1,
             this.H = new Q(null,this.F))
     };
     O.prototype.toString = function() {
         ...
         if (c || "file" == b)
             a.push("//"),
             (b = this.ka) && a.push(Rc(b, Sc, !0), "@"),
             a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")),
             c = this.j,
             null != c && a.push(":", String(c));
         if (c = this.M)
             this.N && "/" != c.charAt(0) && a.push("/"),
             a.push(Rc(c, "/" == c.charAt(0) ? Tc : Uc, !0));
         (c = this.H.toString()) && a.push("?", c);
         (c = this.L) && a.push("#", Rc(c, Vc));
         return a.join("")
     }
     ;
     ...
     var Nc = function(a, b, c) {
       ...
       , Pc = function(a, b, c) {
         P(a);
         b instanceof Q ? (a.H = b,
         a.H.ub(a.F)) : (c || (b = Rc(b, Wc)),
         a.H = new Q(b,a.F))
     };
     ...
     var Qc = function(a, b) {
       ...
       , Rc = function(a, b, c) {
         return "string" === typeof a ? (a = encodeURI(a).replace(b, Yc),
     ...
     m.fa = function(a) {
         ...
         var b = [];
         if ("string" === typeof a)
             $c(this, a) && (b = b.concat(this.h.get(Zc(this, a))));
         else {
     ...
     m.set = function(a, b) {
         ...
         this.D = null;
         a = Zc(this, a);
         $c(this, a) && (this.A = xa(this.A) - this.h.get(a).length);
         this.h.set(a, [b]);
         this.A = xa(this.A) + 1;
         return this
     }
     ...
     ;
     Q.prototype.extend = function(a) {
         for (var b = 0; b < arguments.length; b++)
             Jc(arguments[b], function(c, d) {
                 this.add(d, c)
             }, this)
     }
     ;
     var ad = []
       ...
       , ed = window.whitelistedDomainsHashedValueListForGpayButtonWithCardInfo || []
       , fd = window.denylistedDomainsHashedValueListForGpayButtonWithCardInfo || []
       , gd = window.denylistedMerchentIdsHashedValueListForGpayButtonWithCardInfo || [];
     function hd(a, b, c) {
         a = void 0 === a ? {} : a;
     ...
     function id(a) {
         ...
         cd.push(a.buttonRootNode || document));
         var b = ld(a)
           , c = document.createElement("button");
         kd(c, a);
         c.setAttribute("class", (-1658203989 === uc(dd) ? "gpay-button" : "") + " gpay-card-info-container " + b);
         var d = document.createElement("div");
         d.setAttribute("class", nd(a) ? "\n    gpay-card-info-animation-container new_style black\n    " : S(a) ? "\n    gpay-card-info-animation-container white\n    " : "\n    gpay-card-info-animation-container black\n    ");
         b = document.createElement("div");
         b.setAttribute("class", "gpay-card-info-placeholder-container");
         var e = document.createElement("div");
         e.setAttribute("class", nd(a) ? "\n    gpay-card-info-animation-gpay-logo new_style black\n    " : S(a) ? "\n    gpay-card-info-animation-gpay-logo white\n    " : "\n    gpay-card-info-animation-gpay-logo black\n    ");
         var g = Gc(S(a) ? Ma : nd(a) ? Oa : Na)
           , f = document.createElement("div");
         f.setAttribute("class", "gpay-card-info-animated-progress-bar-container");
         var h = document.createElement("div");
         h.setAttribute("class", nd(a) ? "\n    gpay-card-info-animated-progress-bar-new_style\n    " : "\n    gpay-card-info-animated-progress-bar\n    ");
         var l = document.createElement("div");
         l.setAttribute("class", nd(a) ? "\n    gpay-card-info-animated-progress-bar-indicator-new_style\n    " : "\n    gpay-card-info-animated-progress-bar-indicator\n    ");
         h.appendChild(l);
         b.appendChild(e);
         "fill" !== a.buttonSizeMode ? b.appendChild(g) : (e = Gc(S(a) ? Pa : Qa),
         ...
         k.setAttribute("class", "gpay-card-info-iframe");
         k.setAttribute("scrolling", "no");
         b = new O("https://pay.google.com/gp/p/generate_gpay_btn_img");
         Xc(b, "buttonColor", a.buttonColor);
         Xc(b, "browserLocale", jd(a.buttonLocale));
         Xc(b, "buttonSizeMode", a.buttonSizeMode);
         Xc(b, "enableGpayNewButtonAsset", google.payments.api.EnableGpayNewButtonAsset || !1);
         void 0 !== a.allowedPaymentMethods && Xc(b, "allowedPaymentMethods", JSON.stringify(a.allowedPaymentMethods));
         k.src = b.toString();
         k.onload = function() {
             k.classList.add("gpay-card-info-iframe-fade-in");
     ...
     function kd(a, b) {
         ...
         if (google.payments.api.EnableGpayButtonAriaLabelLocalization) {
             var d = jd(b.buttonLocale, !0);
             switch (b.buttonType) {
             case "buy":
             case "long":
                 var e;
                 c = null != (e = F.buy[d]) ? e : c;
                 break;
             case "book":
                 var g;
                 c = null != (g = F.book[d]) ? g : c;
                 break;
             case "checkout":
                 var f;
                 c = null != (f = F.checkout[d]) ? f : c;
                 break;
             case "donate":
                 var h;
                 c = null != (h = F.donate[d]) ? h : c;
                 break;
             case "order":
                 var l;
                 c = null != (l = F.order[d]) ? l : c;
                 break;
             case "pay":
                 var k;
                 c = null != (k = F.pay[d]) ? k : c;
                 break;
             case "subscribe":
                 var q;
                 c = null != (q = F.subscribe[d]) ? q : c;
                 break;
             case "short":
             case "plain":
                 c = "Google Pay";
     ...
     function ld(a) {
         ...
         return !S(a) && google.payments.api.EnableGpayNewButtonAsset ? b + " " + c + " new_style " + jd(a.buttonLocale) : b + " " + c + " " + jd(a.buttonLocale)
     }
     function S(a) {
     ...
     function nd(a) {
         return google.payments.api.EnableGpayNewButtonAsset && !S(a)
     }
     ;var od = function() {}
       , pd = function(a, b) {
     ...
     var sd = function(a, b, c, d) {
         return r.Promise.resolve(r.Promise.race([pd("PAYMENT_AUTHORIZATION", c), b.onPaymentAuthorized(a)])).then(function(e) {
             return d("paymentAuthorizationResponse", e)
         }, function(e) {
             rd("REQUEST_TIMEOUT" === e.message, 27, 2);
             return d("paymentAuthorizationResponse", qd(e, "PAYMENT_AUTHORIZATION"))
         })
     }
       , td = function(a, b, c, d) {
         return r.Promise.resolve(r.Promise.race([pd(a.callbackTrigger in Ca ? Ca[a.callbackTrigger] : "UNKNOWN_INTENT", c), b.onPaymentDataChanged(a)])).then(function(e) {
             return d("paymentDataCallbackResponse", e)
         }, function(e) {
             rd("REQUEST_TIMEOUT" === e.message, 26, fc[a.callbackTrigger]);
             return d("paymentDataCallbackResponse", qd(e, a.callbackTrigger || "UNKNOWN_INTENT"))
         })
     };
     var vd = function() {
     ...
     vd.prototype.show = function(a) {
         this.Va = a || null;
         this.Jb.body.appendChild(this.O);
         ud(this.O, {
             display: "block",
             opacity: 0
         });
     ...
     var xd = function(a) {
         a.Va = null;
         a.O.parentElement && wd(a.O, {
             opacity: 0
         }).then(function() {
             ud(a.O, {
                 display: "none"
             });
             a.Jb.body.removeChild(a.O)
         })
     };
     function ud(a, b) {
         for (var c in b)
     ...
     function wd(a, b) {
         ...
         return (new r.Promise(function(e) {
             c.setTimeout(function() {
                 c.setTimeout(e, 300);
                 ud(a, t(Object, "assign").call(Object, {
     ...
     ;var yd = function(a) {
         this.s = a;
         this.lb = this.mb = this.B = this.ba = null;
         this.ia = 3E4
     };
     m = yd.prototype;
     m.qb = function(a) {
     ...
     m.prefetchPaymentData = function(a) {
         zd(a, this.s, a.transactionInfo.currencyCode, a.transactionInfo.totalPrice)
     }
     ;
     ...
     var zd = function(a, b, c, d) {
         ...
         return new PaymentRequest([{
             supportedMethods: [b && "SANDBOX" === b && google.payments.api.EnablePaymentHandlerSandboxBuyflow ? "https://pay.sandbox.google.com/gp/p/payment_method_manifest.json" : "https://google.com/pay"],
             data: e
         }],{
             total: {
       ...
       , Ad = function(a, b) {
         b = zd(b, a.s, b.transactionInfo && b.transactionInfo.currencyCode || void 0, b.transactionInfo && b.transactionInfo.totalPrice || void 0);
         b.onpaymentmethodchange = function(c) {
             var d = new od;
             d = c.methodDetails.callbackTrigger ? td(c.methodDetails, a.B, a.ia, d.Qb) : sd(c.methodDetails, a.B, a.ia, d.Qb);
             c.updateWith(d)
         }
         ;
         a.ba(b.show().then(function(c) {
     ...
     var Bd = ["SHIPPING_ADDRESS", "SHIPPING_OPTION"];
     function Cd(a) {
         if (2 <= a.apiVersion) {
             var b = Dd(a);
     ...
     function Ed(a, b) {
         return 2 <= a.apiVersion && (a = Dd(a)) && t(a, "includes").call(a, b) ? !0 : !1
     }
     function Fd() {
         ...
         if (2 <= a.apiVersion) {
             ...
             for (var b = 0; b < a.allowedPaymentMethods.length; b++) {
                 ...
                 if ("CARD" == c.type) {
                     ...
                     if (!c || !Array.isArray(c) || 0 == c.length || !c.every(Jd))
                         return "allowedAuthMethods must be setup in parameters for type 'CARD'  and must contain 'CRYPTOGRAM_3DS' and/or 'PAN_ONLY'"
                 }
             }
         } else if (!a.allowedPaymentMethods || !Array.isArray(a.allowedPaymentMethods) || 0 == a.allowedPaymentMethods.length || !a.allowedPaymentMethods.every(Kd))
     ...
     function Id(a) {
         return 2 > a.apiVersion || !a.allowedPaymentMethods ? null : Md(a, "UPI")
     }
     function Nd(a, b) {
     ...
     function Dd(a) {
         return a.allowedPaymentMethods && (a = Md(a, "CARD")) && a.parameters ? a.parameters.allowedAuthMethods : null
     }
     function Md(a, b) {
     ...
     ;var Pd = function(a, b) {
         ...
         if (!c) {
             var d = Ec();
             c = d;
             void 0 === a.style[d] && (d = (zc ? "Webkit" : yc ? "Moz" : xc ? "ms" : null) + Fc(d),
     ...
     var Qd = function(a, b) {
         ...
         b = b.map(function(c) {
             ...
             var d = c.yc + " " + c.duration + "s " + c.timing + " " + c.delay + "s";
             A(c.yc && "number" === typeof c.duration && c.timing && "number" === typeof c.delay, "Unexpected css3 property value: %s", d);
             return d
         });
         Pd(a, b.join(","))
     };
     ...
     var Sd = function(a, b) {
         ...
         this.defaultPrevented = this.Ba = !1
     };
     ...
     var Vd = function(a, b) {
         ...
         if (a) {
             ...
             this.screenY = d.screenY || 0) : (this.offsetX = zc || void 0 !== a.offsetX ? a.offsetX : a.layerX,
             ...
             this.state = a.state;
             this.va = a;
             a.defaultPrevented && Vd.Ea.preventDefault.call(this)
         }
     };
     ra(Vd, Sd);
     var Ud = fb({
     ...
     $d.prototype.add = function(a, b, c, d, e) {
         ...
         var f = ae(a, b, d, e);
         -1 < f ? (b = a[f],
         c || (b.La = !1)) : (b = new Yd(b,this.src,g,!!d,e),
         b.La = c,
         a.push(b));
         return b
     }
     ...
     $d.prototype.gb = function(a, b, c, d) {
         a = this.v[a.toString()];
         var e = -1;
         a && (e = ae(a, b, c, d));
         return -1 < e ? a[e] : null
     ...
     var ae = function(a, b, c, d) {
         for (var e = 0; e < a.length; ++e) {
             var g = a[e];
             if (!g.Ca && g.listener == b && g.capture == !!c && g.Qa == d)
                 return e
         }
         return -1
     };
     var ce = "closure_lm_" + (1E6 * Math.random() | 0)
       ...
       , ge = function(a, b, c, d, e) {
         if (d && d.once)
             ...
             c = he(c),
             a && a[Wd] ? (d = y(d) ? !!d.capture : !!d,
             ie(a),
             a.J.add(String(b), c, !1, d, e)) : je(a, b, c, !1, d, e)
     }
       ...
       , fe = function(a, b, c, d, e) {
         if (Array.isArray(b))
             ...
             c = he(c),
             a && a[Wd] ? a.J.add(String(b), c, !0, y(d) ? !!d.capture : !!d, e) : je(a, b, c, !0, d, e)
     }
       , oe = function(a, b, c, d, e) {
         if (Array.isArray(b))
             ...
             d = y(d) ? !!d.capture : !!d,
             c = he(c),
             a && a[Wd] ? a.J.remove(String(b), c, d, e) : a && (a = ke(a)) && (b = a.gb(b, c, d, e)) && pe(b)
     }
       , pe = function(a) {
     ...
     T.prototype.dispatchEvent = function(a) {
         ...
         e = !0;
         if (c)
             for (var g = c.length - 1; !a.Ba && 0 <= g; g--) {
                 var f = a.currentTarget = c[g];
                 e = re(f, d, !0, a) && e
             }
         a.Ba || (f = a.currentTarget = b,
         e = re(f, d, !0, a) && e,
         a.Ba || (e = re(f, d, !1, a) && e));
         if (c)
             for (g = 0; !a.Ba && g < c.length; g++)
     ...
     T.prototype.gb = function(a, b, c, d) {
         return this.J.gb(String(a), b, c, d)
     }
     ;
     ...
     ;
     var ie = function(a) {
         A(a.J, "Event target is not initialized. Did you call the superclass (goog.events.EventTarget) constructor?")
     };
     var se = function(a, b) {
         T.call(this);
         this.Ra = a || 1;
         this.Ga = b || w;
         this.Eb = qa(this.Ic, this);
         this.Ob = Date.now()
     };
     ra(se, T);
     m = se.prototype;
     ...
     m.Ic = function() {
         if (this.enabled) {
             ...
             0 < a && a < .8 * this.Ra ? this.K = this.Ga.setTimeout(this.Eb, this.Ra - a) : (this.K && (this.Ga.clearTimeout(this.K),
             this.K = null),
     ...
     m.start = function() {
         this.enabled = !0;
         this.K || (this.K = this.Ga.setTimeout(this.Eb, this.Ra),
         this.Ob = Date.now())
     }
     ;
     m.stop = function() {
         this.enabled = !1;
         this.K && (this.Ga.clearTimeout(this.K),
         this.K = null)
     }
     ;
     m.ua = function() {
 ...
 */
     ...
     function we(a) {
         ...
         void 0 !== a.jb && (b.originVerified = a.jb);
     ...
     var V = function(a, b, c) {
         ...
         this.yb = null;
         this.zb = !1;
         this.U = this.Ta = this.V = this.j = null;
         this.Db = this.pc.bind(this)
     };
     V.prototype.connect = function(a) {
         if (this.V)
             throw Error("already connected");
         this.V = a;
         this.g.addEventListener("message", this.Db)
     }
     ;
     V.prototype.disconnect = function() {
         ...
         this.j && (Ae(this.j),
         this.j = null),
         this.g.removeEventListener("message", this.Db),
         this.U)) {
             for (var a in this.U) {
                 var b = this.U[a];
                 b.port1 && Ae(b.port1);
     ...
     ;
     var Be = function(a) {
         a.V && !a.yb && (a.yb = "function" == typeof a.xb ? a.xb() : a.xb);
         return a.yb
     }
       , Ce = function(a) {
         if (null == a.C)
       ...
       , Fe = function(a, b) {
         var c = null;
         a.zb && "function" == typeof a.g.MessageChannel && (c = new a.g.MessageChannel);
         c ? (De(a, "start", b, [c.port2]),
         Ee(a, c.port1)) : De(a, "start", b)
     }
       , De = function(a, b, c, d) {
         c = {
         ...
         if (!this.Ac || Be(this) == a.source) {
             ...
             if (b && "__ACTIVITIES__" == b.sentinel) {
                 ...
                 if (!this.j || "connect" == c || "start" == c) {
                     ...
                     null == this.C && a.source && Be(this) == a.source && (this.C = d);
     ...
     V.prototype.oa = function(a, b, c) {
         "connect" == a ? (this.j && (Ae(this.j),
         this.j = null),
         this.zb = b && b.acceptsChannel || !1,
         this.V(a, b)) : "start" == a ? ((c = c.ports && c.ports[0]) && Ee(this, c),
         this.V(a, b)) : "msg" == a ? null != this.Ta && null != b && this.Ta(b) : "cnget" == a ? (b = b.name || "",
         a = Ge(this, b),
         a.port1 || (c = new this.g.MessageChannel,
         a.port1 = c.port1,
         a.port2 = c.port2,
         a.Yb(a.port1)),
         a.port2 && (De(this, "cnset", {
             name: b
         }, [a.port2]),
     ...
     var He = function(a, b, c) {
         ...
         this.Ya = b;
         this.Ja = c || null;
         this.g = this.xa.ownerDocument.defaultView;
         this.C = Lc(Ya(b).toString());
         this.ta = null;
         this.cb = new r.Promise(function(e) {
             d.ta = e
         }
         );
         this.Wa = null;
         ...
         this.I = null;
         this.Xa = new r.Promise(function(e) {
             d.I = e
         }
         );
         this.Xb = this.Rb = null;
         this.m = new V(this.g,function() {
             return d.xa.contentWindow
         }
         ,this.C)
     };
     m = He.prototype;
     m.connect = function() {
         ...
         a = this.xa;
         b = this.Ya;
         if (!y(a) || !y(a) || !y(a) || 1 !== a.nodeType || a.namespaceURI && "http://www.w3.org/1999/xhtml" !== a.namespaceURI || a.tagName.toUpperCase() !== "IFRAME".toString()) {
     ...
     ;
     m.Pa = function() {
         return this.xa.contentWindow || null
     }
     ;
     ...
     ;
     m.oa = function(a, b) {
         "connect" == a ? (Fe(this.m, this.Ja),
         this.ta()) : "result" == a ? this.I && (a = b.code,
         b = new te(a,"failed" == a ? Error(b.data || "") : b.data,"iframe",Ce(this.m),!0,!0),
         xe(this.g, b, this.I),
         this.I = null,
         De(this.m, "close"),
         this.disconnect()) : "ready" == a ? this.Wa && (this.Wa(),
         this.Wa = null) : "resize" == a && (this.Xb = b.height,
         this.Rb && this.Rb(this.Xb))
     }
     ;
     var Ie = function(a, b, c, d, e, g) {
         var f = this
           , h = d && C(d);
         ...
         this.ha = g || {};
         this.ta = null;
         this.cb = new r.Promise(function(l) {
             f.ta = l
         }
         );
         this.I = null;
         this.Xa = new r.Promise(function(l) {
             f.I = l
         }
         );
         this.m = this.P = this.Y = null
     };
     m = Ie.prototype;
     m.open = function() {
         return Je(this)
     ...
     var Je = function(a) {
         ...
         if (!a.ha.wd) {
             var d = we({
                 requestId: a.zc,
                 Zb: a.ha.Zb || ue(a.g.location.href),
                 ic: a.Ja
             });
             c = c + (-1 == c.indexOf("#") ? "#" : "&") + encodeURIComponent("__WA__") + "=" + encodeURIComponent(d)
         }
         d = a.wc;
         "_top" != C(d) && ye(a.g) && (d = D("_top"));
         try {
             var e = Dc(c, a.g, d, b)
         } catch (g) {}
         if (!e && "_top" != C(d) && !a.ha.ud) {
             d = D("_top");
             try {
                 e = Dc(c, a.g, d)
             } catch (g) {}
         ...
         e ? (a.Y = e,
         "_top" != C(d) && Le(a)) : Me(a, Error("failed to open window"));
         return a.Xa.catch(function() {})
     }
       , Ke = function(a) {
         var b = a.g.screen
     ...
     Ie.prototype.W = function(a, b) {
         if (this.I) {
             ...
             a = new te(a,b,"popup",c ? Ce(this.m) : Lc(this.Ya),c,c);
             xe(this.g, a, this.I);
             this.I = null
         }
         this.m && De(this.m, "close");
         this.disconnect()
     }
     ;
     Ie.prototype.oa = function(a, b) {
         var c = this;
         "connect" == a ? (Fe(this.m, this.Ja),
         this.ta()) : "result" == a ? (a = b.code,
         this.W(a, "failed" == a ? Error(b.data || "") : b.data)) : "check" == a && this.g.setTimeout(function() {
             return Ne(c)
         }, 200)
     }
     ;
     ...
     Oe.prototype.Ia = function() {
         var a = this
           , b = new te(this.lc,this.mc,"redirect",this.C,this.Hc,!1);
         return new r.Promise(function(c) {
             xe(a.g, b, c)
         }
         )
     ...
     Pe.prototype.open = function(a, b, c, d, e) {
         return {
             xd: Re(this, a, b, c, d, e).Pa()
         }
     }
     ;
     var Se = function(a, b, c, d, e) {
         var g = Re(a, "GPAY", b, c, d, e);
         return g.cb.then(function() {
             return g
         })
     };
     Pe.prototype.ya = function(a, b) {
         var c = this.sb[a];
         c || (c = [],
         this.sb[a] = c);
         c.push(b);
                     ...
                     if (g && g.requestId == a) {
                         ...
                         if (f) {
                             ...
                             do
                                 if (e = f.indexOf(h, e),
                                 -1 != e) {
                                     var l = 0 < e ? f.substring(e - 1, e) : "";
                                     if ("" == l || "?" == l || "#" == l || "&" == l) {
                                         var k = f.indexOf("&", e + 1);
                                         -1 == k && (k = f.length);
                                         f = f.substring(0, e) + f.substring(k + 1)
                                     } else
                                         e++
                                 }
                         ...
                         var z = g.code
                           , E = g.data
                           , G = g.origin
                           , na = d.document.referrer && Lc(d.document.referrer);
                         c = new Oe(d,z,E,G,G == na)
                     } else
                         c = null
                 } else
                     c = null
     ...
     ;
     var Re = function(a, b, c, d, e, g) {
         var f = new Ie(a.g,b,c,d,e,g);
     ...
     var W = function(a, b, c, d) {
         ...
         this.Ib = this.j = null;
         this.Wb = d || null;
         this.lb = this.mb = this.B = this.Da = null;
         this.ia = 3E4;
     ...
     W.prototype.ya = function(a) {
         this.ba || (this.ba = a,
         this.Ab.ya("GPAY", this.vc.bind(this)))
     }
     ;
     W.prototype.vc = function(a) {
         var b = this;
         xd(this.Lb);
         this.ba(a.Ia().then(function(c) {
             if ("TIN" != b.s && c.origin != Ve(b))
                 throw Error("channel mismatch");
             var d = c.data;
             if (d.redirectEncryptedCallbackData)
                 return jc = 3,
                 We(b, d.redirectEncryptedCallbackData).then(function(e) {
         ...
         return new r.Promise(function(c, d) {
             if (Cd(a))
                 ...
                 var e = window.navigator.userAgent
                   ...
                   , f = 0 < e.indexOf("Instagram")
                   , h = 0 < e.indexOf("FB_IAB")
                   , l = 0 < e.indexOf("AndroidMapsWebView");
                 if ((0 < e.indexOf("GSA/") && 0 < e.indexOf("Safari") || g || f || h || l) && !b.Za)
                     c({
                         result: !1
                     });
                 else {
                     ...
                     var k = 0 < e.indexOf("Chrome") || 0 < e.indexOf("Firefox") || 0 < e.indexOf("Safari") || f || g;
                     k && 2 <= a.apiVersion && a.existingPaymentMethodRequired ? (a.environment = b.s,
                     mc(a, 6, ["isReadyToPayResponse", "isReadyToPayError"], function(q) {
                         var z = {
                             result: k
                         };
                         a.existingPaymentMethodRequired && (q.data.isReadyToPayError ? d({
                             statusCode: "DEVELOPER_ERROR",
                             statusMessage: "Ready to pay error. Cause : " + q.data.isReadyToPayError
                         }) : z.paymentMethodPresent = "READY_TO_PAY" == q.data.isReadyToPayResponse);
                         c(z)
                     })) : c({
                         result: k
                     })
     ...
     W.prototype.prefetchPaymentData = function(a) {
         if (this.Za) {
             this.sa(a);
             var b = Ye(this, a)
               , c = Ze(this, b.container, b.iframe, a, $e(a));
             this.Aa = {
     ...
     W.prototype.loadPaymentData = function(a) {
         ...
         if (this.Za) {
             ...
             if (this.Aa) {
                 var d = this.Aa;
                 c = this.Aa.dataPromise;
                 this.Aa = null
             } else
                 d = Ye(this, a),
                 c = Ze(this, d.container, d.iframe, a, c);
             af(this, d.container, d.iframe, a);
             history.pushState({}, "", window.location.href);
             var e = function(g) {
                 g.preventDefault();
                 g = d;
                 g.container.parentNode && (b.Ib(r.Promise.reject({
                     errorCode: "CANCELED"
                 })),
                 bf(g.container, g.iframe),
                 b.j && b.j.disconnect());
             ...
             this.ba(r.Promise.race([c, a]))
         } else
             return jc = a.forceRedirect ? 3 : 2,
             Se(this.Ab, cf(this, c), a.forceRedirect ? D("_top") : D("gp-js-popup"), a, df(a)).then(function(g) {
                 var f = new od;
                 b.Lb.show(g && g.Pa());
                 ...
                 g.onMessage(function(h) {
                     "partialPaymentDataCallback" == h.type ? b.mb = td(h.data, b.B, b.ia, f.Sa).then(function(l) {
                         return g.message(l)
                     }) : "fullPaymentDataCallback" == h.type && (b.lb = sd(h.data, b.B, b.ia, f.Sa).then(function(l) {
                         g.message(l)
                     }))
                 })
             })
     ...
     var Ve = function(a) {
       ...
       , Xe = function(a) {
         var b = Ve(a) + "/gp/p/apis/buyflow/process";
         a.Wb && (b += "?rk=" + encodeURIComponent(a.Wb));
         return b
     }
       , $e = function(a) {
         var b;
         if (null == (b = a.i) ? 0 : b.disableNgbf)
             return !1;
         var c;
         return (null == (c = a.callbackIntents) ? 0 : c.length) || a.vd ? !1 : !0
     }
       , cf = function(a, b) {
         a = "TIN" == a.s ? "/ui/pay" : Ve(a) + "/gp/p/ui/pay";
         b && (a += "?ng=true");
         return a
     }
       , ef = function(a, b, c) {
         var d = window.location.origin
           , e = D("https://pay.google.com/%{path}");
         if ("CANARY" == a)
             e = D("https://ibfe-canary.corp.google.com/%{path}");
         else if ("SANDBOX" == a || "PREPROD" == a)
             e = D("https://pay" + ("PREPROD" == a ? "-preprod" : "") + ".sandbox.google.com/%{path}");
         a = {
             origin: d,
             coordination_token: void 0 === c ? "" : c,
             ng: b
         };
         e = bb(e, {
             path: D("gp/p/ui/pay")
         ...
         e = cb.exec(e);
         b = e[3] || "";
         return ab(e[1] + db("?", e[2] || "", a) + db("#", b))
     }
       , bf = function(a, b) {
         ff(b, "all 250ms ease 0s");
         b.height = "0px";
         setTimeout(function() {
     ...
     var af = function(a, b, c, d) {
         ...
         setTimeout(function() {
             ...
             setTimeout(function() {
                 a.vb = !0;
                 a.Da && (ff(c, a.Da.transition),
                 c.height = a.Da.height,
                 a.Da = null)
             }, 250)
         }, 1)
     }
       ...
       , Ze = function(a, b, c, d, e) {
         ...
         var g = "";
         d.i && d.i.coordinationToken && (g = d.i.coordinationToken);
         d.environment = a.s;
         var f;
         e = ef(a.s, e, g);
         return Qe(c, e, d).then(function(h) {
             a.j = h;
             var l = new od;
             h.onMessage(function(k) {
                 "partialPaymentDataCallback" == k.type ? a.mb = td(k.data, a.B, a.ia, l.Sa).then(function(q) {
                     return h.message(q)
                 }) : "fullPaymentDataCallback" == k.type ? a.lb = sd(k.data, a.B, a.ia, l.Sa).then(function(q) {
                     return h.message(q)
                 }) : "resize" == k.type && (a.vb ? (f || (f = Date.now()),
                 Date.now() < f + 250 ? ff(c, k.transition + ", height 250ms") : ff(c, k.transition),
                 c.height = k.height) : a.Da = {
                     height: k.height,
     ...
     ;
     var gf = "actions.google.com amp-actions.sandbox.google.com amp-actions-staging.sandbox.google.com amp-actions-autopush.sandbox.google.com payments.developers.google.com payments.google.com".split(" "), Y = function(a, b, c, d) {
         this.ib = b;
         Gd(a);
         this.Pb = null;
         this.s = a.environment || "TEST";
         hf || (hf = -1 != gf.indexOf(window.location.hostname) && a.i && a.i.googleTransactionId ? a.i.googleTransactionId : rc(this.s));
         google.payments.api.EnableChromeOriginTrialForPaymentHandlerMinimalHeader && jf(this.s);
         this.G = a;
         this.Hb = a.merchantInfo && a.merchantInfo.merchantId ? a.merchantInfo.merchantId : "";
         a.paymentDataCallback && (a.paymentDataCallbacks = {
             onPaymentDataChanged: a.paymentDataCallback
         });
         this.B = null;
         this.l = new kf(a,c);
         this.Z = new W(this.s,c,d,a.i && a.i.redirectKey);
         this.la = 5;
         this.T = null;
         b = this.l.mode;
         this.na = 5 === b || 4 === b ? new yd(this.s) : this.Z;
         a.paymentDataCallbacks && (this.B = a.paymentDataCallbacks,
         this.na.qb(a.paymentDataCallbacks),
         this.Z.qb(a.paymentDataCallbacks));
         this.Z.ya(this.Sb.bind(this));
         this.na.ya(this.Sb.bind(this));
         jc = b;
         hc = hf;
         N({
             eventType: 9,
         ...
         window.addEventListener("message", function(e) {
             -1 != gf.indexOf(window.location.hostname) && "logPaymentData" === e.data.name && N(e.data.data)
         })
     }, hf, jf = function(a) {
         if (a = Sa[a]) {
     ...
     Y.prototype.isReadyToPay = function(a) {
         ...
         var g = Fd() || Hd(a);
         if (g)
             return new r.Promise(function(k, q) {
                 vc({
                     aa: "isReadyToPay",
                     errorMessage: g
                 });
     ...
     var nf = function(a, b, c, d, e) {
       ...
       , lf = function(a, b, c) {
         if (google.payments.api.DisableNativeReadyToPayCheckForPaymentHandler ? 4 === a.l.mode && !pf(b) : a.l.Fa && !pf(b)) {
             if (2 <= b.apiVersion)
                 return qf(a, b, c);
             var d = a.Z.isReadyToPay(b)
       ...
       , qf = function(a, b, c) {
         ...
         var f = d;
         Ed(b, "PAN_ONLY") && (c.push(9),
         f = a.Z.isReadyToPay(b));
     ...
     m.prefetchPaymentData = function(a) {
         var b = Fd() || Ld(a);
         b ? vc({
             aa: "prefetchPaymentData",
             errorMessage: b
         }) : (this.sa(a),
         this.l.Fa && !pf(a) ? this.na.prefetchPaymentData(a) : this.Z.prefetchPaymentData(a))
     }
     ;
     ...
     m.loadPaymentData = function(a) {
         ...
         jc = this.l.mode;
         if (e)
             this.ib(new r.Promise(function(l, k) {
                 N({
                     eventType: 1,
                     error: 2,
                     buyFlowMode: b.la,
     ...
     var mf = null
       ...
       , kf = function(a, b) {
         ...
         this.bb.paymentDataCallbacks && this.o.push(97),
         a = !0) : (this.o.push(36),
         a = !1));
         this.ra = a;
         this.Fa = tf(this);
         this.mode = 2;
         b ? (this.o = [38],
         this.mode = 1) : this.Fa && this.ra ? this.mode = 5 : this.Fa && (this.mode = 4);
         this.bb.paymentDataCallbacks && this.o.push(1)
     }
       , pf = function(a) {
         return !0 === (a.i && a.i.disableNative)
     }
       , rf = function(a, b, c) {
         return 2 === a.mode || 1 === a.mode ? a.mode : pf(b) ? (c.push(3),
         2) : !sf && (a.ra || google.payments.api.UseCanMakePaymentForFallbackOnMobile && a.Fa) ? (c.push(40),
     ...
     var Z = function(a, b) {
         a = void 0 === a ? {} : a;
         this.tc = sc({}, window.gpayMerchantIdFromUrl ? {
             merchantInfo: {
                 merchantId: window.gpayMerchantIdFromUrl
             }
         } : {}, window.gpayInitParams, a);
         this.Ka = new Y(this.tc,this.xc.bind(this),b);
         this.za = null
     };
     m = Z.prototype;
     m.xc = function(a) {
     ...
     ;
     m.isReadyToPay = function(a) {
         return this.Ka.isReadyToPay(a)
     }
     ;
     m.prefetchPaymentData = function(a) {
         this.Ka.prefetchPaymentData(a)
     }
     ;
     m.notifyAvailableOffers = function() {}
     ;
